...
GLUON_RESNET_TORCH_HUB = 'rwightman/pytorch-pretrained-gluonresnet' # This is open source, not me
...
def resnet34_v1b(pretrained=False, weight_dir=None, **kwargs):
    ...
    if pretrained:
        ...
        if weight_dir is None:
            ...
            filtered_orig_dict = torch.load(weight_dir,map_location='cpu')#['state_dict']
        model_dict.update(filtered_orig_dict)
        model.load_state_dict(model_dict)
    return model


def resnet50_v1s(pretrained=False, weight_dir=None, **kwargs):
    ...
    if pretrained:
        ...
        if weight_dir is None:
            ...
            filtered_orig_dict = torch.load(weight_dir,map_location='cpu')
        model_dict.update(filtered_orig_dict)
        model.load_state_dict(model_dict)
    return model


def resnet101_v1s(pretrained=False, weight_dir=None, **kwargs):
...
def resnet152_v1s(pretrained=False, weight_dir=None, **kwargs):
