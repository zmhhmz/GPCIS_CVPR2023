...
def parse_args():
    ...
    parser.add_argument("--max_num_next_clicks", type=int, default=3)
    
    parser.add_argument("--num_max_points", type=int, default=24)

    parser.add_argument('--gp_model', type=str, default='')
    
    parser.add_argument('--noprev_mask', action='store_true')
    
    parser.add_argument('--nodisk', action='store_true')

    parser.add_argument('--binary_prev_mask', action='store_true')
    
    parser.add_argument("--image_dump_interval", type=int, default=500)
    
    parser.add_argument("--crop_size", type=int, default=256)

    parser.add_argument('--milestones', type=int, nargs='+', default=[190,210,230])
